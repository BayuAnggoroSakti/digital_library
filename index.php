...
{
  echo "<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert'><i class='icon-remove'></i></button><strong>Maaf, tidak ditemukan data ebook yang sesuai</strong></div>";
}
