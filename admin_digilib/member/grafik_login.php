...
valueSuffix: ' '
         ...
         yAxis: {
           ...
           $sql   = "SELECT distinct useragent FROM digilib_statistiklogin ds, digilib_userlogin du, member m where ds.id_userlogin = du.id_userlogin and du.member_id = m.member_id";
            ...
            while( $ret = mysql_fetch_array( $query ) ){
              $merek=$ret['useragent'];  
                if ( $awal != '' && $akhir != '') {
                     ...
                     where ds.id_userlogin = du.id_userlogin and du.member_id = m.member_id and ds.datetime BETWEEN '$awal' and '$akhir' and useragent ='$merek' ";

                }
                else{
                   $sql_jumlah   = "SELECT count(id_statistiklogin) as jum FROM digilib_statistiklogin ds, digilib_userlogin du, member m 
                     where ds.id_userlogin = du.id_userlogin and du.member_id = m.member_id and useragent ='$merek'"; 
                }
